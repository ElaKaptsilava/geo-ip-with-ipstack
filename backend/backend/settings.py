...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-2a3_yltre9d&kmj9h!1ji-mx&pokw)^pre6r6k9hcdtn6&()fe"
)
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "geolocationAPI.serializers.MyTokenObtainPairSerializer",
